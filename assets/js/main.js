...
// Global helper to open WhatsApp with optional product name (uses admin WhatsApp number)
function openWhatsAppOrder(variation) {
  var phone = (typeof Store !== "undefined" && Store.getWhatsappNumber) ? Store.getWhatsappNumber() : "";
  if (!phone) return;
  var fc = typeof Store !== "undefined" && Store.getFloatingContact ? Store.getFloatingContact() : {};
  var baseMsg = (fc && fc.defaultMessage) || "Hi Black T-Shirt, I'd like to order a T-shirt.";
