...
(function () {
  ...
  /** Set href on all [data-whatsapp-link] from Store.getWhatsappNumber() (single source of truth). Optional data-whatsapp-text for message. */
  function applyWhatsAppLinks() {
    var number = (typeof Store !== 'undefined' && Store.getWhatsappNumber) ? Store.getWhatsappNumber() : '';
    var defaultMsg = (typeof Store !== 'undefined' && Store.getFloatingContact) ? (Store.getFloatingContact().defaultMessage || "Hi Black T-Shirt, I'd like to order a T-shirt.") : "Hi Black T-Shirt, I'd like to order a T-shirt.";
    document.querySelectorAll('[data-whatsapp-link]').forEach(function (a) {
      ...
      var msg = (a.getAttribute('data-whatsapp-text') || defaultMsg).trim();
      a.setAttribute('href', 'https://wa.me/' + number + (msg ? '?text=' + encodeURIComponent(msg) : ''));
      a.removeAttribute('aria-disabled');
    });
  }

  document.addEventListener('click', function (e) {
    var a = e.target && e.target.closest ? e.target.closest('[data-whatsapp-link]') : null;
